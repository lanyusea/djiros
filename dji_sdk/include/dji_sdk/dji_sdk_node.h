#ifndef __DJI_SDK_DJI_SDK_NODE_H__
#define __DJI_SDK_DJI_SDK_NODE_H__
...
//Actions:
    ...
    bool drone_task_action_callback(const dji_sdk::DroneTaskGoal::ConstPtr& goal);
    bool global_position_navigation_action_callback(const dji_sdk::GlobalPositionNavigationGoal::ConstPtr& goal);
    bool local_position_navigation_action_callback(const dji_sdk::LocalPositionNavigationGoal::ConstPtr& goal);
    bool waypoint_navigation_action_callback(const dji_sdk::WaypointNavigationGoal::ConstPtr& goal);
