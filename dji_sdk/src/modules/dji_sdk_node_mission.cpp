...
void DJISDKMission::mission_status_callback(uint8_t *buf, size_t len)
{
...
void DJISDKMission::mission_event_callback(uint8_t *buf, size_t len)
{
...
{
    DJI::onboardSDK::HotPointData new_hotpoint;
    DJI::onboardSDK::FollowData new_follow;
...
bool DJISDKMission::mission_wp_upload_callback(dji_sdk::MissionWpUpload::Request& request, dji_sdk::MissionWpUpload::Response& response)
{
    ...
    for (auto waypoint:waypoint_task.mission_waypoint) {
        new_waypoint.latitude = waypoint.latitude * M_PI / 180;
        new_waypoint.longitude = waypoint.longitude * M_PI / 180;
...
bool DJISDKMission::mission_hp_upload_callback(dji_sdk::MissionHpUpload::Request& request, dji_sdk::MissionHpUpload::Response& response)
{
    ...
    hotpoint_task.latitude = hotpoint_task.latitude * M_PI/180;
    hotpoint_task.longitude = hotpoint_task.longitude * M_PI/180;
...
bool DJISDKMission::mission_fm_upload_callback(dji_sdk::MissionFmUpload::Request& request, dji_sdk::MissionFmUpload::Response& response)
{
    ...
    followme_task.initial_latitude = followme_task.initial_latitude * M_PI/180;
    followme_task.initial_longitude = followme_task.initial_longitude * M_PI/180;
...
DJISDKMission::DJISDKMission(ros::NodeHandle& nh, DJI::onboardSDK::ROSAdapter* rosAdapter): rosAdapter(rosAdapter)
{
    init_missions(nh);
